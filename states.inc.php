...
$machinestates = array(
    ...
    STATE_PLAY_CARD => array(
        "name" => "playerTurn",
        "description" => clienttranslate('${round_type}: ${actplayer} must play a ${company} card'),
        "descriptionmyturn" => clienttranslate('${round_type}: ${you} must play a ${company} card'),
        "descriptionany" => clienttranslate('${round_type}: ${actplayer} must play any card (no ${company} cards in hand)'),
        "descriptionmyturnany" => clienttranslate('${round_type}: ${you} must play any card (no ${company} cards in hand)'),
        "descriptionlead" => clienttranslate('${round_type}: ${actplayer} must lead the trick'),
        "descriptionmyturnlead" => clienttranslate('${round_type}: ${you} must lead the trick'),
        "type" => "activeplayer",
    ...
    STATE_ADD_LOCOMOTIVE => array(
        "name" => "addLocomotive",
        "description" => clienttranslate( '${actplayer} must place Locomotive ${locomotive}' ),
        "descriptionmyturn" => clienttranslate( '${you} must place Locomotive ${locomotive}' ),
        "type" => "activeplayer",
